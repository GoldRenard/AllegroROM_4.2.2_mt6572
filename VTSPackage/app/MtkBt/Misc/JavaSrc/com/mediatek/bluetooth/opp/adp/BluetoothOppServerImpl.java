...
class BluetoothOppServerImpl extends android.bluetooth.IBluetoothOpp.Stub
{
    ...
    public BluetoothDevice getConnectedDevice()
        throws RemoteException
    {
        android.net.Uri uri = mManager.oppsGetCurrentTask();
    ...
    public int getState()
        throws RemoteException
    {
        return mManager.oppsGetCurrentTask() == null ? 2 : 1;
    }
}
