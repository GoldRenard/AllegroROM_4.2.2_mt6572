...
;
    ...
    protected boolean inflateViews(NotificationData.Entry entry, ViewGroup viewgroup)
    {
        ...
        if (remoteviews == null)
            return false;
        View view = ((LayoutInflater)super.mContext.getSystemService("layout_inflater")).inflate(0x7f04002d, viewgroup, false);
        view.setTag(statusbarnotification.pkg);
        workAroundBadLayerDrawableOpacity(view);
        updateNotificationVetoButton(view, statusbarnotification).setContentDescription(super.mContext.getString(0x7f0b00a0));
        ViewGroup viewgroup1 = (ViewGroup)view.findViewById(0x7f0800b4);
        ViewGroup viewgroup2 = (ViewGroup)view.findViewById(0x7f0800b5);
...
_L3:
    ...
    protected View updateNotificationVetoButton(View view, StatusBarNotification statusbarnotification)
    {
        ...
        if (statusbarnotification.isClearable())
        {
            view1.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                {
                    view2.announceForAccessibility(mContext.getString(0x7f0b00c4));
                    try
                    {
    ...
    protected void updateSearchPanel()
    {
        ...
        mSearchPanelView = (SearchPanelView)LayoutInflater.from(super.mContext).inflate(0x7f040030, linearlayout, false);
