...
class GlobalScreenshot
{
    ...
    public GlobalScreenshot(Context context)
    {
        ...
        mScreenshotLayout = layoutinflater.inflate(0x7f04000a, null);
        mBackgroundView = (ImageView)mScreenshotLayout.findViewById(0x7f080060);
        mScreenshotView = (ImageView)mScreenshotLayout.findViewById(0x7f080061);
        mScreenshotFlash = (ImageView)mScreenshotLayout.findViewById(0x7f080062);
        ...
        mWindowLayoutParams = new android.view.WindowManager.LayoutParams(-1, -1, 0, 0, 2015, 0x10804fb, -3);
...
;
    ...
    {
        Resources resources = context.getResources();
        notificationmanager.notify(789, (new android.app.Notification.Builder(context)).setTicker(resources.getString(0x7f0b0048)).setContentTitle(resources.getString(0x7f0b0048)).setContentText(resources.getString(0x7f0b0049)).setSmallIcon(0x7f020139).setWhen(System.currentTimeMillis()).setAutoCancel(true).getNotification());
    }
