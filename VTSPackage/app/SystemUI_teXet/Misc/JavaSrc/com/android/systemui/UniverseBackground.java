...
;
    ...
    public UniverseBackground(Context context)
    {
        ...
        mContent = View.inflate(context, 0x7f04004c, null);
        addView(mContent);
        mContent.findViewById(0x7f080124).setOnClickListener(new android.view.View.OnClickListener() {
        ...
        mBottomAnchor = mContent.findViewById(0x7f080126);
