...
;
        mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent)
            {
                ...
                if ("AllegroSettings.intent.action.TRANSPARENCY_CHANGED".equals(s))
                {
                    int l = intent.getIntExtra("value", 255);
                    Xlog.d("PhoneStatusBar", (new StringBuilder()).append("Transparency intent was found. Calling SetBackgroundTransparency(").append(l).append(")").toString());
                    SetBackgroundTransparency(l);
                    return;
                }
                if ("android.intent.action.ACTION_BOOT_IPO".equals(s))
                {
                    ...
                    {
                        View view1 = mNavigationBarView.findViewById(0x7f080064);
...
;
    ...
    private void refreshExpandedView(Context context)
    {
        ...
        if (mHasFlipSettings)
        {
            ImageView imageview = (ImageView)mStatusBarWindow.findViewById(0x7f0800ad);
            if (imageview != null)
        ...
        if (mHasSettingsPanel)
        {
            if (mStatusBarView.hasFullWidthNotifications())
                ((ImageView)mStatusBarWindow.findViewById(0x7f0800ac)).setImageDrawable(context.getResources().getDrawable(0x7f020028));
        } else
        {
            ((ImageView)mStatusBarWindow.findViewById(0x7f0800ac)).setImageDrawable(context.getResources().getDrawable(0x7f020030));
        }
        ((ImageView)mStatusBarWindow.findViewById(0x7f0800aa)).setImageDrawable(context.getResources().getDrawable(0x7f020023));
        ((ImageView)mStatusBarWindow.findViewById(0x7f0800a9)).setImageDrawable(context.getResources().getDrawable(0x7f020030));
    }
    ...
    private void setStatusBarLowProfile(boolean flag)
    {
        ...
        {
            View view = mStatusBarView.findViewById(0x7f08004b);
            View view1 = mStatusBarView.findViewById(0x7f08004f);
            View view2 = mStatusBarView.findViewById(0x7f080051);
            View view3 = mStatusBarView.findViewById(0x7f080053);
            View view4 = mStatusBarView.findViewById(0x7f080054);
...
label1:
    ...
    private void updateNetworkName(boolean flag, String s, boolean flag1, String s1)
    {
        ...
        {
            if (flag2)
                stringbuilder.append(super.mContext.getString(0x7f0b005c));
    ...
    {
        Log.d("PhoneStatusBar", (new StringBuilder()).append("Changing background transparency to ").append(i).toString());
        mStatusBarView.setBackgroundColor(i * 0x1000000);
    }
...
, 50L);
    ...
    protected PhoneStatusBarView makeStatusBarView()
    {
        ...
        mStatusBarWindow = (StatusBarWindowView)View.inflate(context, 0x7f040009, null);
        mStatusBarView = (PhoneStatusBarView)mStatusBarWindow.findViewById(0x7f080048);
        SetBackgroundTransparency(android.provider.Settings.System.getInt(context.getContentResolver(), "status_bar_transparency", 255));
        ...
        PanelHolder panelholder = (PanelHolder)mStatusBarWindow.findViewById(0x7f08005e);
        mStatusBarView.setPanelHolder(panelholder);
        mNotificationPanel = (NotificationPanelView)mStatusBarWindow.findViewById(0x7f080058);
        ...
        try
        {
            ...
            {
                mNavigationBarView = (NavigationBarView)View.inflate(context, 0x7f04000c, null);
        ...
        mPixelFormat = -1;
        mSystemIconArea = (LinearLayout)mStatusBarView.findViewById(0x7f08004e);
        mStatusIcons = (LinearLayout)mStatusBarView.findViewById(0x7f08004f);
        mNotificationIcons = (IconMerger)mStatusBarView.findViewById(0x7f08004d);
        mNotificationIcons.setOverflowIndicator(mMoreIcon);
        mStatusBarContents = (LinearLayout)mStatusBarView.findViewById(0x7f08004a);
        mTickerView = mStatusBarView.findViewById(0x7f080055);
        mToolBarSwitchPanel = mStatusBarWindow.findViewById(0x7f08005a);
        mToolBarView = (ToolBarView)mStatusBarWindow.findViewById(0x7f080123);
        toolbarindicator = (ToolBarIndicator)mStatusBarWindow.findViewById(0x7f08011d);
        ...
        mSimIndicatorIcon = (ImageView)mStatusBarView.findViewById(0x7f08001f);
        super.mPile = (NotificationRowLayout)mStatusBarWindow.findViewById(0x7f08005d);
        super.mPile.setLayoutTransitionsEnabled(false);
        ...
        mClearButton = mStatusBarWindow.findViewById(0x7f0800aa);
        mClearButton.setOnClickListener(mClearButtonListener);
        mClearButton.setAlpha(0.0F);
        mClearButton.setVisibility(8);
        mClearButton.setEnabled(false);
        mDateView = (DateView)mStatusBarWindow.findViewById(0x7f0800a7);
        mHasSettingsPanel = resources.getBoolean(0x7f0a0009);
        mHasFlipSettings = resources.getBoolean(0x7f0a000a);
        mDateTimeView = mNotificationPanelHeader.findViewById(0x7f0800a6);
        if (mHasFlipSettings)
        {
            mDateTimeView.setOnClickListener(mClockClickListener);
            mDateTimeView.setEnabled(true);
        }
        mSettingsButton = (ImageView)mStatusBarWindow.findViewById(0x7f0800ac);
        if (mSettingsButton != null)
        {
            mSettingsButton.setOnClickListener(mSettingsButtonListener);
            if (mHasSettingsPanel)
            {
                mHeaderSettingsButton = mStatusBarWindow.findViewById(0x7f0800a9);
                ...
                {
                    View view2 = mStatusBarWindow.findViewById(0x7f0800ab);
                    if (view2 != null)
        ...
        if (mHasFlipSettings)
        {
            mNotificationButton = (ImageView)mStatusBarWindow.findViewById(0x7f0800ad);
            if (mNotificationButton != null)
                mNotificationButton.setOnClickListener(mNotificationButtonListener);
        }
        mScrollView = (ScrollView)mStatusBarWindow.findViewById(0x7f08005c);
        mScrollView.setVerticalScrollBarEnabled(false);
        if (!mNotificationPanelIsFullScreenWidth)
            mScrollView.setSystemUiVisibility(0x8a0000);
        mTicker = new MyTicker(context, mStatusBarView);
        ((TickerView)mStatusBarView.findViewById(0x7f080057)).mTicker = mTicker;
        mEdgeBorder = resources.getDimensionPixelSize(0x7f0d0000);
        setAreThereNotifications();
        mLocationController = new LocationController(super.mContext);
        mBatteryController = new BatteryController(super.mContext);
        mBatteryController.addIconView((ImageView)mStatusBarView.findViewById(0x7f080053));
        mBatteryController.addLabelView((TextView)mStatusBarWindow.findViewById(0x7f080052));
        mCircleBattery = (CircleBattery)mStatusBarWindow.findViewById(0x7f08012a);
        mBatteryController.addStateChangedCallback(mCircleBattery);
        mBluetoothController = new BluetoothController(super.mContext);
        mCarrier1 = (CarrierLabelGemini)mStatusBarWindow.findViewById(0x7f080014);
        mCarrier2 = (CarrierLabelGemini)mStatusBarWindow.findViewById(0x7f080016);
        mCarrier3 = (CarrierLabelGemini)mStatusBarWindow.findViewById(0x7f080018);
        mCarrier4 = (CarrierLabelGemini)mStatusBarWindow.findViewById(0x7f08001a);
        mCarrierDivider = mStatusBarWindow.findViewById(0x7f080015);
        mCarrierDivider2 = mStatusBarWindow.findViewById(0x7f080017);
        mCarrierDivider3 = mStatusBarWindow.findViewById(0x7f080019);
        mCarrierLabelGemini = (LinearLayout)mStatusBarWindow.findViewById(0x7f080013);
        ...
        signalclusterviewgemini = (SignalClusterViewGemini)mStatusBarView.findViewById(0x7f080051);
        ...
        if (mHasSettingsPanel)
        {
            if (mHasFlipSettings)
            {
                view1 = mStatusBarWindow.findViewById(0x7f08005b);
                if (view1 != null)
                {
            ...
            {
                View view = mStatusBarWindow.findViewById(0x7f08005f);
                if (view != null)
                    mSettingsPanel = (SettingsPanelView)((ViewStub)view).inflate();
                else
                    mSettingsPanel = (SettingsPanelView)mStatusBarWindow.findViewById(0x7f080070);
            ...
            mSettingsContainer = (QuickSettingsContainerView)mStatusBarWindow.findViewById(0x7f080012);
        ...
        intentfilter.addAction("AllegroSettings.intent.action.TRANSPARENCY_CHANGED");
    ...
    protected void setAreThereNotifications()
    {
        ...
        final View nlo = mStatusBarView.findViewById(0x7f080049);
        int k;
        if (j != 0 && !areLightsOn())
            k = i;
        else
        ...
        } else
        {
            ...
            
            {
                ...
                super();
                    ...
                    mCling.findViewById(0x7f0800af).setOnClickListener(new android.view.View.OnClickListener() {
...
, 500L);
    ...
    public void showClock(boolean flag)
    {
        ...
        {
            View view = mStatusBarView.findViewById(0x7f080054);
            if (view != null)
            {
                byte byte0;
                if (flag)
...
;
    ...
    void updateResources()
    {
        ...
        if (mClearButton instanceof TextView)
            ((TextView)mClearButton).setText(context.getText(0x7f0b0040));
