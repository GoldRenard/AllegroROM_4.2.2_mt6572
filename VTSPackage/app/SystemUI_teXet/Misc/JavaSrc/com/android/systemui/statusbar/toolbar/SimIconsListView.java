...
public class SimIconsListView extends ListView
{
    ...
    private class SimInfotListAdapter extends BaseAdapter
    {
        ...
        public View getView(int i, View view, ViewGroup viewgroup)
        {
            ...
            if (view == null)
            {
                view = mInflater.inflate(0x7f040045, null);
                siminfoviewholder = new SimInfoViewHolder();
                siminfoviewholder.mSimBg = (RelativeLayout)view.findViewById(0x7f080116);
                siminfoviewholder.mSimType = (TextView)view.findViewById(0x7f080118);
                siminfoviewholder.mSimShortNumber = (TextView)view.findViewById(0x7f080119);
                siminfoviewholder.mSimStatus = (ImageView)view.findViewById(0x7f080117);
                siminfoviewholder.mSimOpName = (TextView)view.findViewById(0x7f08011a);
                siminfoviewholder.mSimNumber = (TextView)view.findViewById(0x7f08011b);
                siminfoviewholder.mSimSelectedRadio = (RadioButton)view.findViewById(0x7f08011c);
