...
label0:
        {
            ...
            if (inputmethodsubtype != null)
                ...
                obj = context.getString(0x7f0b00dc);
            return obj.toString();
        }
        return null;
    }
    ...
    public void onBatteryLevelChanged(int i, int j)
    {
        ...
        BatteryState batterystate = mBatteryState;
        boolean flag;
        if (j == 2)
            flag = true;
        else
            flag = false;
        batterystate.pluggedIn = flag;
        mBatteryCallback.refreshView(mBatteryTile, mBatteryState);
    }
    ...
    public void onBrightnessLevelChanged()
    {
        ...
        mBrightnessState.label = resources.getString(0x7f0b00d9);
...
_L1:
    ...
    void onRotationLockChanged()
    {
        ...
        String s;
        if (flag)
            s = mContext.getString(0x7f0b00db);
        else
    ...
    public void onWifiDisplayStateChanged(WifiDisplayStatus wifidisplaystatus)
    {
        ...
        {
            mWifiDisplayState.label = mContext.getString(0x7f0b00e9);
    ...
    void refreshSettingsTile()
    {
        ...
        {
            Resources resources = mContext.getResources();
            mSettingsState.label = resources.getString(0x7f0b00e1);
