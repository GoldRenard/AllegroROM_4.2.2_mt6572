...
public final class Constraints
{
        ...
        implements Constraint
    {
        ...
        static 
        {
            ...
            NotNullConstraint anotnullconstraint[] = new NotNullConstraint[1];
            anotnullconstraint[0] = INSTANCE;
            $VALUES = anotnullconstraint;
        }
    ...
    {
        java.util.ArrayList arraylist = Lists.newArrayList(collection);
        for (Iterator iterator = arraylist.iterator(); iterator.hasNext(); constraint.checkElement(iterator.next()));
        return arraylist;
    }
