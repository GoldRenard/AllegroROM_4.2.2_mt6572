...
;
        ...
        implements BiMap
    {
        ...
        {
            super.constraint.checkKeyValue(obj, obj1);
        ...
        {
            if (inverse == null)
                inverse = new ConstrainedBiMap(_mthdelegate().inverse(), this, new InverseConstraint(super.constraint));
            return inverse;
        }
...
;
        ...
        implements MapConstraint
    {
        ...
        static 
        {
            ...
            NotNullMapConstraint anotnullmapconstraint[] = new NotNullMapConstraint[1];
            anotnullmapconstraint[0] = INSTANCE;
            $VALUES = anotnullmapconstraint;
        }
    ...
    private static Map checkMap(Map map, MapConstraint mapconstraint)
    {
        ...
        for (Iterator iterator = linkedhashmap.entrySet().iterator(); iterator.hasNext(); mapconstraint.checkKeyValue(entry.getKey(), entry.getValue()))
    ...
    private static Collection checkValues(Object obj, Iterable iterable, MapConstraint mapconstraint)
    {
        ...
        for (Iterator iterator = arraylist.iterator(); iterator.hasNext(); mapconstraint.checkKeyValue(obj, iterator.next()));
        return arraylist;
    }
