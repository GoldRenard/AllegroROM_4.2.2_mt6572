...
public final class LinkedHashMultimap extends AbstractSetMultimap
{
    private class SetDecorator extends ForwardingSet
    {
        ...
        Collection createEntries(Collection collection)
        {
            ...
            for (Iterator iterator1 = collection.iterator(); iterator1.hasNext(); arraylist.add(createEntry(iterator1.next())));
            return arraylist;
        }
...
;
        ...
        throws IOException, ClassNotFoundException
    {
        ...
        linkedEntries = new LinkedHashSet(i * expectedValuesPerKey);
