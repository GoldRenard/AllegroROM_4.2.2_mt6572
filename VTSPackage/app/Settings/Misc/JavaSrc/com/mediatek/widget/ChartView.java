...
//            ChartSweepView, ChartBandwidthNetworkSeriesView, ChartBandwidthGridView
...
public class ChartView extends FrameLayout
{
    ...
    protected void onLayout(boolean flag, int i, int j, int k, int l)
    {
        ...
        for (int k1 = 0; k1 < getChildCount(); k1++)
        {
            ...
            rect.set(mContent);
            if (!(view instanceof ChartBandwidthNetworkSeriesView) && !(view instanceof ChartBandwidthGridView))
            {
