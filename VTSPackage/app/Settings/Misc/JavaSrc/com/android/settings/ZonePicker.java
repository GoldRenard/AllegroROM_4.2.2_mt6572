...
public class ZonePicker extends ListFragment
{
    ...
    {
        return constructTimezoneAdapter(context, flag, 0x7f040030);
    }
    ...
    private static List getZones(Context context)
    {
        ...
        for (xmlresourceparser = context.getResources().getXml(0x7f05003f); xmlresourceparser.next() != 2;);
...
_L1:
    ...
    {
        menu.add(0, 1, 0, 0x7f0b036b).setIcon(0x108009c);
        menu.add(0, 2, 0, 0x7f0b036c).setIcon(0x7f020066);
