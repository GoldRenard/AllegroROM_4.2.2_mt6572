...
;
    ...
    {
        QuickSettingsTileView quicksettingstileview = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview.setContent(0x7f040016, layoutinflater);
        if (!IS_Tablet)
        {
            viewgroup.addView(quicksettingstileview);
            mDynamicSpannedTiles.add(quicksettingstileview);
        }
        QuickSettingsTileView quicksettingstileview1 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview1.setContent(0x7f04001a, layoutinflater);
        ...
        mModel.addBatteryTile(quicksettingstileview1, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview13, QuickSettingsModel.State state)
            {
                ...
                ImageView imageview = (ImageView)quicksettingstileview13.findViewById(0x7f08008b);
                ...
                if (batterystate.batteryLevel == 100)
                    s = mContext.getString(0x7f0b00d4);
                else
                if (batterystate.pluggedIn)
                {
                    ...
                    s = context1.getString(0x7f0b00d3, aobj1);
                } else
                {
                    Context context = mContext;
                    Object aobj[] = new Object[1];
                    aobj[0] = Integer.valueOf(batterystate.batteryLevel);
                    s = context.getString(0x7f0b005a, aobj);
                }
                imageview.setImageDrawable(levellistdrawable);
                imageview.setImageLevel(batterystate.batteryLevel);
                textview.setText(s);
                quicksettingstileview13.setContentDescription(mContext.getString(0x7f0b00ca, new Object[] {
                    s
                }));
            }
        ...
        if (IS_Tablet)
        {
            QuickSettingsTileView quicksettingstileview12 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
            quicksettingstileview12.setContent(0x7f040024, layoutinflater);
            ...
            mModel.addSettingsTile(quicksettingstileview12, new QuickSettingsModel.RefreshCallback() {
                ...
                public void refreshView(QuickSettingsTileView quicksettingstileview13, QuickSettingsModel.State state)
                {
                    ((TextView)quicksettingstileview13.findViewById(0x7f08009a)).setText(state.label);
                }
        ...
        QuickSettingsTileView quicksettingstileview2 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview2.setContent(0x7f040028, layoutinflater);
        ...
        QuickSettingsTileView quicksettingstileview3 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview3.setContent(0x7f04001b, layoutinflater);
        ...
        QuickSettingsTileView quicksettingstileview4 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview4.setContent(0x7f04001f, layoutinflater);
        viewgroup.addView(quicksettingstileview4);
        QuickSettingsTileView quicksettingstileview5 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview5.setContent(0x7f04001e, layoutinflater);
        if (!isWifiOnlyDevice())
            viewgroup.addView(quicksettingstileview5);
        QuickSettingsTileView quicksettingstileview6 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview6.setContent(0x7f040023, layoutinflater);
        ...
        mModel.addRSSITile(quicksettingstileview6, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview13, QuickSettingsModel.State state)
            {
                ((TextView)quicksettingstileview13.findViewById(0x7f080099)).setText(0x7f0b0032);
            }
        ...
        QuickSettingsTileView quicksettingstileview7 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview7.setContent(0x7f040018, layoutinflater);
        ...
        QuickSettingsTileView quicksettingstileview8 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview8.setContent(0x7f04001c, layoutinflater);
        ...
        mModel.addBrightnessTile(quicksettingstileview8, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview13, QuickSettingsModel.State state)
            {
                TextView textview = (TextView)quicksettingstileview13.findViewById(0x7f080090);
        ...
        QuickSettingsTileView quicksettingstileview9 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview9.setContent(0x7f040026, layoutinflater);
        viewgroup.addView(quicksettingstileview9);
        QuickSettingsTileView quicksettingstileview10 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview10.setContent(0x7f040022, layoutinflater);
        ...
        mModel.addRotationLockTile(quicksettingstileview10, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview13, QuickSettingsModel.State state)
            {
                TextView textview = (TextView)quicksettingstileview13.findViewById(0x7f080097);
                textview.setCompoundDrawablesWithIntrinsicBounds(0, state.iconId, 0, 0);
                textview.setText(state.label);
            }
        ...
        QuickSettingsTileView quicksettingstileview11 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview11.setContent(0x7f040019, layoutinflater);
    ...
    {
        QuickSettingsTileView quicksettingstileview = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview.setContent(0x7f040017, layoutinflater);
        ...
        mModel.addAlarmTile(quicksettingstileview, new QuickSettingsModel.RefreshCallback() {
            ...
            {
                ((TextView)quicksettingstileview3.findViewById(0x7f080086)).setText(state.label);
                byte byte0;
                if (state.enabled)
                    byte0 = 0;
                else
                ...
                Object aobj[] = new Object[1];
                aobj[0] = state.label;
                quicksettingstileview3.setContentDescription(context.getString(0x7f0b00cd, aobj));
            }
        ...
        viewgroup.addView(quicksettingstileview);
        QuickSettingsTileView quicksettingstileview1 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview1.setContent(0x7f040029, layoutinflater);
        quicksettingstileview1.setOnClickListener(new android.view.View.OnClickListener() {
        ...
        mModel.addWifiDisplayTile(quicksettingstileview1, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview3, QuickSettingsModel.State state)
            {
                TextView textview = (TextView)quicksettingstileview3.findViewById(0x7f0800a5);
                textview.setText(state.label);
                textview.setCompoundDrawablesWithIntrinsicBounds(0, state.iconId, 0, 0);
        ...
        viewgroup.addView(quicksettingstileview1);
        QuickSettingsTileView quicksettingstileview2 = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview2.setContent(0x7f04001d, layoutinflater);
    ...
    {
        QuickSettingsTileView quicksettingstileview = (QuickSettingsTileView)layoutinflater.inflate(0x7f040015, viewgroup, false);
        quicksettingstileview.setContent(0x7f040027, layoutinflater);
        quicksettingstileview.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            {
                mBar.collapseAllPanels(true);
                if (((UserManager)mContext.getSystemService("user")).getUsers(true).size() > 1)
                {
                    try
                    {
                    ...
                    {
                        Log.e("QuickSettings", "Couldn't show user switcher", remoteexception);
                    }
                    return;
                } else
                {
        ...
        mModel.addUserTile(quicksettingstileview, new QuickSettingsModel.RefreshCallback() {
            ...
            public void refreshView(QuickSettingsTileView quicksettingstileview1, QuickSettingsModel.State state)
            {
                ...
                ImageView imageview = (ImageView)quicksettingstileview1.findViewById(0x7f0800a0);
                ((TextView)quicksettingstileview1.findViewById(0x7f0800a1)).setText(state.label);
                imageview.setImageDrawable(userstate.avatar);
                Context context = mContext;
                Object aobj[] = new Object[1];
                aobj[0] = state.label;
                quicksettingstileview1.setContentDescription(context.getString(0x7f0b00c7, aobj));
            }
...
, 200L);
    ...
    private void showBrightnessDialog()
    {
        if (mBrightnessDialog == null)
        {
            ...
            mBrightnessDialog.setContentView(0x7f040013);
            mBrightnessDialog.setCanceledOnTouchOutside(true);
            mBrightnessController = new BrightnessController(mContext, (ImageView)mBrightnessDialog.findViewById(0x7f080075), (ToggleSlider)mBrightnessDialog.findViewById(0x7f080076));
