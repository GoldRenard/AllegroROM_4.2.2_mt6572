...
;
    ...
    private View createInputMethodItem(final InputMethodInfo imi, InputMethodSubtype inputmethodsubtype)
    {
        ...
        View view = View.inflate(mContext, 0x7f040039, null);
        ImageView imageview = (ImageView)view.findViewById(0x7f0800de);
        TextView textview = (TextView)view.findViewById(0x7f0800df);
        TextView textview1 = (TextView)view.findViewById(0x7f0800e0);
        ImageView imageview1 = (ImageView)view.findViewById(0x7f0800e2);
        View view1 = view.findViewById(0x7f0800dc);
        ...
        {
            view.findViewById(0x7f0800e1).setVisibility(8);
    ...
    private void updateRadioButtonsByImiAndSubtype(InputMethodInfo inputmethodinfo, InputMethodSubtype inputmethodsubtype)
    {
        if (inputmethodinfo != null)
        {
            for (Iterator iterator = mRadioViewAndImiMap.keySet().iterator(); iterator.hasNext();)
            {
                ...
                RadioButton radiobutton = (RadioButton)view.findViewById(0x7f0800dd);
                if (radiobutton == null)
                {
    ...
    private Pair updateRadioButtonsByView(View view)
    {
        ...
        if (flag)
        {
            for (Iterator iterator = mRadioViewAndImiMap.keySet().iterator(); iterator.hasNext();)
            {
                ...
                RadioButton radiobutton = (RadioButton)view1.findViewById(0x7f0800dd);
                if (radiobutton == null)
                {
                    Log.w("InputMethodsPanel", "RadioButton was not found in the selected subtype view");
                    return null;
    ...
    {
        mInputMethodMenuList = (LinearLayout)findViewById(0x7f0800e7);
        mHardKeyboardSection = (LinearLayout)findViewById(0x7f0800e4);
        mHardKeyboardSwitch = (Switch)findViewById(0x7f0800e6);
        mConfigureImeShortcut = findViewById(0x7f0800e8);
