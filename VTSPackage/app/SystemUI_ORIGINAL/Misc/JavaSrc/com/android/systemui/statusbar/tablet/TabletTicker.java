...
label0:
    ...
    private View makeTickerView(StatusBarNotification statusbarnotification)
    {
        ...
        viewgroup = (ViewGroup)layoutinflater.inflate(0x7f040048, null, false);
        framelayout = (FrameLayout)viewgroup.findViewById(0x7f080118);
        obj = null;
...
_L3:
        ImageView imageview1 = (ImageView)viewgroup.findViewById(0x7f080114);
        if (notification.largeIcon != null)
        {
        ...
        {
            viewgroup = (ViewGroup)layoutinflater.inflate(0x7f040047, mWindow, false);
            ...
            ((TextView)viewgroup.findViewById(0x7f080116)).setText(notification.tickerText);
        } else
        {
