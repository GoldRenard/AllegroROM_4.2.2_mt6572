...
;
    ...
    {
        mSettingsView = LayoutInflater.from(getContext()).inflate(0x7f040046, mContentFrame, false);
    ...
    protected void onAttachedToWindow()
    {
        ...
        latestItems = (NotificationRowLayout)findViewById(0x7f0800b8);
    ...
    public void onFinishInflate()
    {
        ...
        mContentParent = (ViewGroup)findViewById(0x7f0800f0);
        mContentParent.bringToFront();
        mTitleArea = (NotificationPanelTitle)findViewById(0x7f0800f4);
        mTitleArea.setPanel(this);
        mSettingsButton = findViewById(0x7f0800b0);
        mNotificationButton = findViewById(0x7f0800b1);
        mNotificationScroller = findViewById(0x7f0800f3);
        mContentFrame = (ViewGroup)findViewById(0x7f0800f2);
        mContentFrameMissingTranslation = 0.0F;
        mClearButton = findViewById(0x7f0800ae);
