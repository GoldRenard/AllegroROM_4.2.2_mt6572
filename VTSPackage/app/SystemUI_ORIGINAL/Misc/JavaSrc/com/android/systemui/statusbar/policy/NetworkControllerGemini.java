        ...
        do
        {
            ...
            do
            {
                ...
                } else
                {
                    ...
                    mPhoneSignalIconId[i][0].setIconId(0x7f0201ed);
                }
...
label0:
        {
            ...
            if (true)
            {
                ...
                if (!flag4)
                {
                    ...
                    {
                        aiconidwrapper[0].setResources(null);
                        aiconidwrapper[0].setIconId(0x7f0201ed);
                    }
                    flag1 = true;
            ...
            if (!flag1 && servicestate != null)
            {
                ...
                if (k2 == 2)
                {
                    ...
                    {
                        aiconidwrapper[0].setResources(null);
                        aiconidwrapper[0].setIconId(0x7f0201ee);
                    }
                    flag1 = true;
            ...
            if (!flag1 && (servicestate == null || !hasService(i) && !servicestate.isEmergencyOnly()))
            {
                ...
                if (SIMHelper.isSimInserted(i))
                {
                    ...
                    if (1 == SIMHelper.getSimIndicatorStateGemini(i))
                    {
                        flag = true;
                        aiconidwrapper[0].setResources(null);
                        aiconidwrapper[0].setIconId(0x7f0201d7);
                        iconidwrapper.setResources(null);
                        iconidwrapper.setIconId(0x7f0201d7);
                        flag1 = true;
                    }
                }
            }
            if (!flag1)
            {
                ...
                if (!flag2)
                {
                    ...
                    } else
                    {
                        ...
                        aiconidwrapper[0].setIconId(0x7f0201ed);
                        iconidwrapper.setResources(null);
                        iconidwrapper.setIconId(0x7f0201d8);
                    }
                } else
                if (signalstrength == null)
                {
                    aiconidwrapper[0].setResources(null);
                    aiconidwrapper[0].setIconId(0x7f0201d8);
                    iconidwrapper.setResources(null);
                    iconidwrapper.setIconId(0x7f0201d8);
...
label0:
        {
            ...
            if (!s.equals("android.net.wifi.RSSI_CHANGED") && !s.equals("android.net.wifi.WIFI_STATE_CHANGED") && !s.equals("android.net.wifi.STATE_CHANGE"))
            {
                if (s.equals("android.intent.action.SIM_STATE_CHANGED"))
                {
                    ...
                    SIMHelper.updateSimInsertedStatus();
                    updateTelephonySignalStrength(i1);
...
label0:
        {
            ...
            } else
            {
                ...
                if (flag1)
                {
                    ...
                    } else
                    {
                        ...
                        case 2: // '\002'
                            iconidwrapper6.setIconId(0x7f020218);
                            break;

                        case 1: // '\001'
                            iconidwrapper6.setIconId(0x7f02020d);
                            break;
            ...
            } else
            {
                ...
                if (SIMHelper.isSimInserted(i))
                {
                    ...
                    mPhoneSignalIconId[i][0].setResources(null);
                    mPhoneSignalIconId[i][0].setIconId(0x7f0201d7);
                    mDataTypeIconId[i].setResources(null);
                    mDataTypeIconId[i].setIconId(0);
                }
                if (mWifiConnected)
