    ...
    implements android.widget.AdapterView.OnItemClickListener, RecentsCallback, StatusBarPanel, android.animation.Animator.AnimatorListener
{
    ...
    final class TaskDescriptionAdapter extends BaseAdapter
    {
        ...
        public View createView(ViewGroup viewgroup)
        {
            ...
            viewholder.thumbnailView = view.findViewById(0x7f0800bf);
            viewholder.thumbnailViewImage = (ImageView)view.findViewById(0x7f0800c0);
            updateThumbnail(viewholder, mRecentTasksLoader.getDefaultThumbnail(), false, false);
            viewholder.iconView = (ImageView)view.findViewById(0x7f0800be);
            viewholder.iconView.setImageBitmap(mRecentTasksLoader.getDefaultIcon());
            viewholder.labelView = (TextView)view.findViewById(0x7f0800bd);
            viewholder.calloutLine = view.findViewById(0x7f0800c1);
            viewholder.descriptionView = (TextView)view.findViewById(0x7f0800c2);
...
_L4:
    ...
    private void showImpl(boolean flag)
    {
        ...
        if (flag)
        {
            ...
            if (mRecentTaskDescriptions != null && mRecentTaskDescriptions.size() == 0)
                ...
                flag1 = false;
            TextView textview = (TextView)mRecentsNoApps.findViewById(0x7f0800b5);
    ...
    private void updateUiElements()
    {
        ...
        if (j == 0)
        {
            s = getResources().getString(0x7f0b0041);
        } else
        {
...
label1:
                    {
                        if (menuitem.getItemId() == 0x7f08012c)
                        {
    ...
    public void handleSwipe(View view)
    {
        ...
        } else
        {
            ...
            if (activitymanager != null)
            {
                ...
                setContentDescription(context.getString(0x7f0b00a5, aobj));
    ...
    protected void onFinishInflate()
    {
        ...
        mRecentsContainer = (ViewGroup)findViewById(0x7f0800c5);
        ...
        if (mRecentsContainer instanceof RecentsScrollView)
        {
            ...
            mRecentsScrim = findViewById(0x7f0800c4);
            mRecentsNoApps = findViewById(0x7f0800c7);
...
_L1:
        ...
        if (viewgroup instanceof RecentsScrollView)
            viewgroup = (ViewGroup)viewgroup.findViewById(0x7f0800c6);
          goto _L3
_L7:
        int i;
