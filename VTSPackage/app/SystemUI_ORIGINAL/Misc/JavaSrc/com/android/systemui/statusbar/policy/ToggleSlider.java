    ...
    implements android.widget.CompoundButton.OnCheckedChangeListener, android.widget.SeekBar.OnSeekBarChangeListener
{
    ...
    public ToggleSlider(Context context, AttributeSet attributeset, int i)
    {
        ...
        View.inflate(context, 0x7f040035, this);
        ...
        mToggle = (CompoundButton)findViewById(0x7f0800cb);
        mToggle.setOnCheckedChangeListener(this);
        mToggle.setBackgroundDrawable(resources.getDrawable(0x7f02023e));
        mSlider = (SeekBar)findViewById(0x7f0800cc);
        mSlider.setOnSeekBarChangeListener(this);
        mLabel = (TextView)findViewById(0x7f0800cd);
    ...
    public void onCheckedChanged(CompoundButton compoundbutton, boolean flag)
    {
        ...
        if (flag)
        {
            ...
            drawable1 = resources.getDrawable(0x7f02023c);
        } else
        {
