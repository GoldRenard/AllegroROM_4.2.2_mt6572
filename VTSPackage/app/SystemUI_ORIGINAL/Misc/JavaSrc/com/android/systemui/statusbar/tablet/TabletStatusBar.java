...
;
    ...
    protected void addPanelWindows()
    {
        ...
        Resources resources = super.mContext.getResources();
        mNotificationPanel = (NotificationPanel)View.inflate(context, 0x7f04003d, null);
        ...
        mBatteryController.addIconView((ImageView)mNotificationPanel.findViewById(0x7f080031));
        mBatteryController.addLabelView((TextView)mNotificationPanel.findViewById(0x7f0800fa));
        mBluetoothController.addIconView((ImageView)mNotificationPanel.findViewById(0x7f0800ef));
        ImageView imageview = (ImageView)mNotificationPanel.findViewById(0x7f080020);
        if (imageview != null)
            mNetworkController.addPhoneSignalIconView(imageview);
        ImageView imageview1 = (ImageView)mNotificationPanel.findViewById(0x7f080013);
        if (imageview1 != null)
            mNetworkController.addWifiIconView(imageview1);
        mNetworkController.addWifiLabelView((TextView)mNotificationPanel.findViewById(0x7f0800f9));
        mNetworkController.addDataTypeIconView((ImageView)mNotificationPanel.findViewById(0x7f08001e));
        mNetworkController.addMobileLabelView((TextView)mNotificationPanel.findViewById(0x7f0800f6));
        mNetworkController.addCombinedLabelView((TextView)mBarContents.findViewById(0x7f0800ee));
        ...
        updateSearchPanel();
        mInputMethodsPanel = (InputMethodsPanel)View.inflate(context, 0x7f04003a, null);
        ...
        mCompatModePanel = (CompatModePanel)View.inflate(context, 0x7f040038, null);
        ...
        super.mPile = (NotificationRowLayout)mNotificationPanel.findViewById(0x7f0800b8);
    ...
    protected View makeStatusBarView()
    {
        Context context = super.mContext;
        loadDimens();
        TabletStatusBarView tabletstatusbarview = (TabletStatusBarView)View.inflate(context, 0x7f040037, null);
        ...
        mBarContents = (ViewGroup)tabletstatusbarview.findViewById(0x7f0800cf);
        mNotificationArea = tabletstatusbarview.findViewById(0x7f0800d2);
        mNotificationArea.setOnTouchListener(new NotificationTriggerTouchListener());
        mNotificationTrigger = tabletstatusbarview.findViewById(0x7f0800ed);
        mNotificationIconArea = (NotificationIconArea)tabletstatusbarview.findViewById(0x7f08002b);
        mIconLayout = (NotificationIconArea.IconLayout)tabletstatusbarview.findViewById(0x7f0800ec);
        ...
        mBatteryController.addIconView((ImageView)tabletstatusbarview.findViewById(0x7f080031));
        mBluetoothController = new BluetoothController(super.mContext);
        mBluetoothController.addIconView((ImageView)tabletstatusbarview.findViewById(0x7f0800ef));
        mNetworkController = new NetworkController(super.mContext);
        signalclusterview = (SignalClusterView)tabletstatusbarview.findViewById(0x7f08002f);
        mNetworkController.addSignalCluster(signalclusterview);
        mBackButton = (ImageView)tabletstatusbarview.findViewById(0x7f08006a);
        mNavigationArea = (ViewGroup)tabletstatusbarview.findViewById(0x7f0800d0);
        mHomeButton = mNavigationArea.findViewById(0x7f08006b);
        mMenuButton = mNavigationArea.findViewById(0x7f08006d);
        mRecentButton = mNavigationArea.findViewById(0x7f08006c);
        ...
        mFeedbackIconArea = (ViewGroup)tabletstatusbarview.findViewById(0x7f0800e9);
        mInputMethodSwitchButton = (InputMethodButton)tabletstatusbarview.findViewById(0x7f0800ea);
        mInputMethodSwitchButton.setOnClickListener(mOnClickListener);
        mCompatModeButton = (CompatModeButton)tabletstatusbarview.findViewById(0x7f0800eb);
        mCompatModeButton.setOnClickListener(mOnClickListener);
        mCompatModeButton.setVisibility(8);
        mFakeSpaceBar = tabletstatusbarview.findViewById(0x7f0800d1);
        mShadow = tabletstatusbarview.findViewById(0x7f0800d4);
        ...
        ((ViewGroup)tabletstatusbarview.findViewById(0x7f0800ce)).setLayoutTransition(layouttransition1);
        ...
        ((ViewGroup)tabletstatusbarview.findViewById(0x7f0800d3)).setLayoutTransition(layouttransition2);
        setAreThereNotifications();
    ...
    {
        View view = mBarContents.findViewById(0x7f080032);
        View view1 = mBarContents.findViewById(0x7f0800ee);
        if (view != null)
        {
            byte byte1;
            if (flag)
    ...
    protected void updateNotificationIcons()
    {
        if (mIconLayout != null)
        {
            ...
            if (mNotificationDNDMode)
            {
                ...
                {
                    Notification notification = (new Builder(super.mContext)).setContentTitle(super.mContext.getText(0x7f0b00ad)).setContentText(super.mContext.getText(0x7f0b00ae)).setSmallIcon(0x7f02001d).setOngoing(true).getNotification();
