...
;
    ...
    private void buildSimIconViews()
    {
        ...
        {
            com.mediatek.telephony.SimInfoManager.SimInfoRecord siminforecord = (com.mediatek.telephony.SimInfoManager.SimInfoRecord)mSIMInfoList.get(j);
            SimIconView simiconview = (SimIconView)View.inflate(mContext, 0x7f04004c, null);
        ...
        {
            final SimIconView simIconView = (SimIconView)View.inflate(mContext, 0x7f04004d, null);
            simIconView.setSimIconViewResource(0x7f020257);
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        final SimIconView simIconView = (SimIconView)View.inflate(mContext, 0x7f04004d, null);
        simIconView.setSimIconViewResource(0x7f020252);
...
// JavaClassFileOutputException: get_constant: invalid tag
        ...
        {
            final SimIconView simIconView = (SimIconView)View.inflate(mContext, 0x7f04004d, null);
            simIconView.setSimIconViewResource(0x7f020254);
