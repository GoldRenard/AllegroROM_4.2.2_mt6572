...
label0:
        {
            if (!SIMHelper.isSimInserted(i))
            {
                if (i != 0)
                    break label0;
                for (int j = 1; j < mGeminiSimNum; j++)
                    if (SIMHelper.isSimInserted(j))
                        return false;
    ...
    public void apply()
    {
        ...
        for (int i = 0; i < mGeminiSimNum; i++)
        {
            ...
            if (mMobileVisible[i] && flag)
            {
                ...
                if (mMobileStrengthId[i][0].getIconId() == PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthNullIconGemini(i) || mMobileStrengthId[i][0].getIconId() == 0 || mMobileStrengthId[i][0].getIconId() == 0x7f0201ed)
                {
                    mMobileRoam[i].setVisibility(8);
                ...
                if (SIMHelper.isSimInserted(i) && 2 != j && 4 != j && 3 != j && 1 != j)
                {
                    ...
                    if (i1 > -1 && i1 < 4 && mDataNetType[i] != null)
                    {
                        ...
                        mSignalNetworkType[i].setVisibility(0);
                        if (mMobileStrengthId[i][0].getIconId() == PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthNullIconGemini(i) || mMobileStrengthId[i][0].getIconId() == 0 || mMobileStrengthId[i][0].getIconId() == 0x7f0201ed)
                ...
                if (mMobileStrengthId[i][0].getIconId() == PluginFactory.getStatusBarPlugin(mContext).getSignalStrengthNullIconGemini(i) || mMobileStrengthId[i][0].getIconId() == 0x7f0201ed)
                ...
                if (k == mMobileStrengthId[i][0].getIconId() || l == mMobileStrengthId[i][0].getIconId() || mMobileStrengthId[i][0].getIconId() == 0x7f0201ed)
    ...
    protected void onAttachedToWindow()
    {
        ...
        mMobile2[0] = (ImageView)findViewById(0x7f080048);
        mMobileGroup[0] = (ViewGroup)findViewById(0x7f08001f);
        mMobileActivity[0] = (ImageView)findViewById(0x7f080049);
        mMobileType[0] = (ImageView)findViewById(0x7f08001e);
        mMobileRoam[0] = (ImageView)findViewById(0x7f080018);
        mSpacer[0] = findViewById(0x7f080015);
        mMobileSlotIndicator[0] = (ImageView)findViewById(0x7f08004a);
        mSignalClusterCombo[0] = (ViewGroup)findViewById(0x7f08001d);
        mSignalNetworkType[0] = (ImageView)findViewById(0x7f080047);
