...
label1:
                    {
                        ...
                        } else
                        {
                            ...
                            if (mLowBatteryDialog != null && mLowBatteryDialog.isShowing())
                            {
                                ...
                                String s1 = context1.getString(0x7f0b0038, aobj);
                                if (mBatteryLevelTextView != null)
                                {
...
;
    ...
    void showLowBatteryWarning()
    {
        ...
        Object aobj[] = new Object[1];
        aobj[0] = Integer.valueOf(mBatteryLevel);
        String s1 = context.getString(0x7f0b0038, aobj);
        if (mBatteryLevelTextView != null)
        {
            mBatteryLevelTextView.setText(s1);
            return;
        ...
        if (intent.resolveActivity(super.mContext.getPackageManager()) != null)
            builder.setNegativeButton(0x7f0b0037, new android.content.DialogInterface.OnClickListener() {
