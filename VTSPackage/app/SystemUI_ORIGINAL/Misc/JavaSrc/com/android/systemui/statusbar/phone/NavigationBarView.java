...
;
    ...
    {
        return mCurrentView.findViewById(0x7f08006a);
    }
    ...
    {
        return mCurrentView.findViewById(0x7f08006d);
    }

    public View getRecentsButton()
    {
        return mCurrentView.findViewById(0x7f08006c);
    }

    public View getSearchLight()
    {
        return mCurrentView.findViewById(0x7f08006f);
    }
    ...
    public void onFinishInflate()
    {
        ...
        View view = findViewById(0x7f080068);
        aview1[2] = view;
        aview[0] = view;
        mRotatedViews[1] = findViewById(0x7f080071);
        mRotatedViews[3] = findViewById(0x7f080071);
    ...
    public void reorient()
    {
        ...
        mDeadZone = (DeadZone)mCurrentView.findViewById(0x7f080070);
...
label0:
        {
            ...
            {
                ViewGroup viewgroup = (ViewGroup)mCurrentView.findViewById(0x7f080069);
    ...
    public void setLowProfile(boolean flag, boolean flag1, boolean flag2)
    {
        ...
        if (!flag2 && flag == mLowProfile)
            return;
        mLowProfile = flag;
        View view = mCurrentView.findViewById(0x7f080069);
        final View lowLights = mCurrentView.findViewById(0x7f08006e);
        view.animate().cancel();
