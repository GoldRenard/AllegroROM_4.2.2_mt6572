...
public class PhoneStatusBarPolicy
{
    ...
    private static final int sWifiSignalImages[][] = {
        {
            0x7f020228, 0x7f02022a, 0x7f02022c, 0x7f02022e
        }, {
            0x7f020229, 0x7f02022b, 0x7f02022d, 0x7f02022f
        }
    };
    private static final int sWifiTemporarilyNotConnectedImage = 0x7f020227;
...
;
        ...
        mService.setIcon("tty", 0x7f020223, 0, null);
        mService.setIconVisibility("tty", false);
        mService.setIcon("cdma_eri", 0x7f0201fe, 0, null);
        ...
        mService.setIcon("alarm_clock", 0x7f02015f, 0, null);
        mService.setIconVisibility("alarm_clock", false);
        mService.setIcon("sync_active", 0x7f020221, 0, null);
        mService.setIcon("sync_failing", 0x7f020222, 0, null);
        mService.setIconVisibility("sync_active", false);
        mService.setIconVisibility("sync_failing", false);
        mService.setIcon("volume", 0x7f0201fc, 0, null);
        mService.setIconVisibility("volume", false);
        updateVolume();
        mService.setIcon("headset", 0x7f0201f9, 0, null);
...
label0:
        {
            ...
            } else
            {
                ...
                {
                    i = 0x7f020173;
                    s = mContext.getString(0x7f0b0077);
                } else
                {
    ...
    private final void updateHeadSet(Intent intent)
    {
        ...
        if (i != -1 && j != -1)
        {
            if (i == 1)
            {
                ...
                {
                    mService.setIcon("headset", 0x7f0201fa, 0, null);
                    mService.setIconVisibility("headset", true);
                    return;
                }
            } else
    ...
    private final void updateTTY(Intent intent)
    {
        ...
        {
            mService.setIcon("tty", 0x7f020223, 0, mContext.getString(0x7f0b00a2));
    ...
    private final void updateVolume()
    {
        ...
        {
            j = 0x7f0201fd;
            s = mContext.getString(0x7f0b00a3);
        } else
        {
            j = 0x7f0201fc;
