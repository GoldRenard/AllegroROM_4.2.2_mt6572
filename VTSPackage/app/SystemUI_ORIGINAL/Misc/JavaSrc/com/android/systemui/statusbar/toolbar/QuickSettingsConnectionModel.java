    ...
    private final class MobileStateTracker extends StateTracker
    {
        ...
        private int dataSwitchConfirmDlgMsg(long l)
        {
            ...
            if (siminforecord.mDataRoaming != flag)
                flag = false;
            int i = current3GSlotId();
            Xlog.d("QuickSettingsConnectionModel", (new StringBuilder()).append("dataSwitchConfirmDlgMsg, g3SlotId=").append(i).append(" curSlotId=").append(siminforecord.mSimSlotId).toString());
            ...
            return !flag1 || flag ? -1 : 0x7f0b0021;
        }
...
;
    ...
    private void createProfileSwitchDialog()
    {
        if (mProfileSwitchDialog == null)
        {
            ...
            mProfileSwitchDialog.setContentView(0x7f040014);
            ...
            mMettingProfileIcon = (ImageView)mProfileSwitchDialog.findViewById(0x7f08007f);
            mOutdoorSwitchIcon = (ImageView)mProfileSwitchDialog.findViewById(0x7f080082);
            mMuteProfileIcon = (ImageView)mProfileSwitchDialog.findViewById(0x7f08007c);
            mNormalProfileIcon = (ImageView)mProfileSwitchDialog.findViewById(0x7f080079);
            View view = mProfileSwitchDialog.findViewById(0x7f080078);
            ...
            View view1 = mProfileSwitchDialog.findViewById(0x7f08007b);
            ...
            View view2 = mProfileSwitchDialog.findViewById(0x7f08007e);
            ...
            View view3 = mProfileSwitchDialog.findViewById(0x7f080081);
    ...
    {
        mWifiIcon = (ImageView)mWifiTileView.findViewById(0x7f0800a3);
        mBluetoothIcon = (ImageView)mBluetoothTileView.findViewById(0x7f08008e);
        mGpsIcon = (ImageView)mGpsTileView.findViewById(0x7f080094);
        mMobileIcon = (ImageView)mMobileTileView.findViewById(0x7f080092);
        mAirlineModeIcon = (ImageView)mAirlineModeTileView.findViewById(0x7f080084);
        mTimeoutIcon = (ImageView)mTimeoutTileView.findViewById(0x7f08009d);
        mAutoRotateIcon = (ImageView)mAutoRotateTileView.findViewById(0x7f080089);
        mTimeoutIndicator = (ImageView)mTimeoutTileView.findViewById(0x7f08009e);
        mAudioProfileIcon = (ImageView)mAudioProfileTileView.findViewById(0x7f080087);
    }

    private void initLayout()
    {
        mDataConnLayout = (FrameLayout)mMobileTileView.findViewById(0x7f080091);
        mBluetoothLayout = (FrameLayout)mBluetoothTileView.findViewById(0x7f08008d);
        mWifiLayout = (FrameLayout)mWifiTileView.findViewById(0x7f0800a2);
    }
...
label0:
    ...
    {
        ((TextView)mWifiTileView.findViewById(0x7f0800a4)).setText(0x7f0b000d);
        ((TextView)mBluetoothTileView.findViewById(0x7f08008f)).setText(0x7f0b000e);
        ((TextView)mGpsTileView.findViewById(0x7f080095)).setText(0x7f0b0010);
        if (!isWifiOnlyDevice())
            ((TextView)mMobileTileView.findViewById(0x7f080093)).setText(0x7f0b000f);
        ((TextView)mTimeoutTileView.findViewById(0x7f08009f)).setText(0x7f0b0018);
        ((TextView)mAutoRotateTileView.findViewById(0x7f08008a)).setText(0x7f0b0011);
        ((TextView)mAudioProfileTileView.findViewById(0x7f080088)).setText(0x7f0b0033);
        ((TextView)mAirlineModeTileView.findViewById(0x7f080085)).setText(0x7f0b0016);
        if (mSwitchDialog != null)
