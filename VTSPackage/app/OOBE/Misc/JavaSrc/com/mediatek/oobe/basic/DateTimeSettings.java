...
;
    ...
    private void initUI()
    {
        ...
        mDummyDate.set(mDummyDate.get(1), 11, 31, 13, 0, 0);
        mAutoTimePref = (ListPreference)findPreference("auto_time");
        if (flag)
        ...
        String as[] = getResources().getStringArray(0x7f060002);
        ...
        do
        {
            ...
            if (as[i].length() == 0)
                as1[i] = getResources().getString(0x7f090026, new Object[] {
                    s1
                });
            else
                as1[i] = s1;
        ...
        mDateFormat.setEntryValues(0x7f060002);
    ...
    {
        Xlog.d("DateTimeSettings", "reset AutoTimePref as cancel the selection");
        boolean flag = getAutoState("auto_time");
    ...
    static void setDate(int i, int j, int k)
    {
    ...
    static void setTime(int i, int j)
    {
        Calendar calendar = Calendar.getInstance();
        calendar.set(11, i);
        calendar.set(12, j);
    ...
    public void initProgressBar(int i, int j)
    {
        mProgressbarMaxSize = i;
        mCurrentStep = j;
    }
    ...
    {
        Xlog.d("DateTimeSettings", "onCancel Dialog");
        reSetAutoTimePref();
    }
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        if (i == -1)
        {
            Xlog.d("DateTimeSettings", "Enable GPS time sync");
        ...
        if (i == -2)
        {
            Xlog.d("DateTimeSettings", "DialogInterface.BUTTON_NEGATIVE");
            reSetAutoTimePref();
            return;
        }
    }
    ...
    public Dialog onCreateDialog(int i)
    {
        ...
        case 12: // '\f'
            ...
            if (android.provider.Settings.Secure.isLocationProviderEnabled(getContentResolver(), "gps"))
                ...
                j = 0x7f090089;
            return (new android.app.AlertDialog.Builder(getActivity())).setMessage(getActivity().getResources().getString(j)).setTitle(0x7f09010a).setIcon(0x1080027).setPositiveButton(0x1040013, this).setNegativeButton(0x1040009, this).create();
    ...
    {
        Xlog.d("DateTimeSettings", preference.getKey());
        ...
        if (preference == mTimeZone)
        {
            Xlog.d("DateTimeSettings", "time zone preference clicked ");
            Intent intent = new Intent("com.mediatek.oobe.basic.TIMEZONE_PICKER_WIZARD");
            intent.putExtra("oobe_step_total", mProgressbarMaxSize);
            intent.putExtra("oobe_step_index", mCurrentStep);
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedpreferences, String s)
    {
        ...
        {
            String s2 = sharedpreferences.getString(s, getResources().getString(0x7f090032));
            android.provider.Settings.System.putString(getContentResolver(), "date_format", s2);
            updateTimeAndDateDisplay(getActivity());
        } else
        {
            if (s.equals("auto_time"))
            {
