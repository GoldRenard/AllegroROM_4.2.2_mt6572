    ...
    implements android.widget.AdapterView.OnItemClickListener
{
    class SelectionListAdapter extends BaseAdapter
    {
        ...
        {
            viewholder.mTextName = (TextView)view.findViewById(0x7f0b0029);
            viewholder.mTextNum = (TextView)view.findViewById(0x7f0b002a);
            viewholder.mImageStatus = (ImageView)view.findViewById(0x7f0b0026);
            viewholder.mTextNumFormat = (TextView)view.findViewById(0x7f0b0027);
            viewholder.mCkRadioOn = (RadioButton)view.findViewById(0x7f0b002b);
            viewholder.mImageSim = (RelativeLayout)view.findViewById(0x7f0b0025);
        }
        ...
        public View getView(int i, View view, ViewGroup viewgroup)
        {
            ...
            if (view == null)
            {
                view = mFlater.inflate(0x7f030010, null);
