...
;
    ...
    {
        this(context, attributeset, 0x10103df);
    }
    ...
    public TimePicker(Context context, AttributeSet attributeset, int i)
    {
        ...
        int j = typedarray.getResourceId(0, 0x10900dc);
        typedarray.recycle();
        ((LayoutInflater)context.getSystemService("layout_inflater")).inflate(j, this, true);
        mHourSpinner = (NumberPicker)findViewById(0x102039b);
        ...
        mHourSpinnerInput = (EditText)mHourSpinner.findViewById(0x1020341);
        mHourSpinnerInput.setImeOptions(5);
        mDivider = (TextView)findViewById(0x102039f);
        if (mDivider != null)
            mDivider.setText(0x104006b);
        mMinuteSpinner = (NumberPicker)findViewById(0x102039c);
        ...
        mMinuteSpinner.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker numberpicker, int k, int l)
            {
                boolean flag = true;
                updateInputState();
                int i1 = mMinuteSpinner.getMinValue();
                int j1 = mMinuteSpinner.getMaxValue();
                if (k == j1 && l == i1)
                {
        ...
        mMinuteSpinnerInput = (EditText)mMinuteSpinner.findViewById(0x1020341);
        mMinuteSpinnerInput.setImeOptions(5);
        mAmPmStrings = (new DateFormatSymbols()).getAmPmStrings();
        View view = findViewById(0x102039d);
        ...
        } else
        {
            ...
            mAmPmSpinnerInput = (EditText)mAmPmSpinner.findViewById(0x1020341);
    ...
    {
        trySetContentDescription(mMinuteSpinner, 0x1020340, 0x10404bf);
        trySetContentDescription(mMinuteSpinner, 0x1020342, 0x10404c0);
        trySetContentDescription(mHourSpinner, 0x1020340, 0x10404c1);
        trySetContentDescription(mHourSpinner, 0x1020342, 0x10404c2);
        if (mAmPmSpinner != null)
        {
            trySetContentDescription(mAmPmSpinner, 0x1020340, 0x10404c3);
            trySetContentDescription(mAmPmSpinner, 0x1020342, 0x10404c4);
        }
    }
    ...
    public Integer getCurrentHour()
    {
        ...
        if (mIsAm)
            ...
            return Integer.valueOf(12 + i % 12);
    }
    ...
    public void onPopulateAccessibilityEvent(AccessibilityEvent accessibilityevent)
    {
        ...
        String s = DateUtils.formatDateTime(super.mContext, mTempCalendar.getTimeInMillis(), i);
