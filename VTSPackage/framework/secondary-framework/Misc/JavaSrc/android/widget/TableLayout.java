...
*/
    ...
    private static SparseBooleanArray parseColumns(String s)
    {
        ...
        as = Pattern.compile("\\s*,\\s*").split(s);
        i = as.length;
        j = 0;
_L3:
...
label0:
        {
            if (mMaxWidths != null)
            {
                ...
                i1 = android.view.View.MeasureSpec.getSize(i) - super.mPaddingLeft - super.mPaddingRight;
    ...
    {
        return mShrinkAllColumns || mShrinkableColumns.get(i);
    }

    public boolean isColumnStretchable(int i)
    {
        return mStretchAllColumns || mStretchableColumns.get(i);
    }
