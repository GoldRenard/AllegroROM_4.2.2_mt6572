    ...
    extends IInterface
{
    ...
    public static final int DUMP_MESSAGE_HISTORY_TRANSACTION = 48;
    public static final int DUMP_PROVIDER_TRANSACTION = 45;
    public static final int DUMP_SERVICE_TRANSACTION = 22;
    public static final int ENABLE_LOOPER_LOG = 49;
    ...
    public static final int RESET_SL_TRANSACTION = 51;
    ...
    public static final int SET_TRIM_MEMORY_FLAG_EX = 50;
    ...
    public abstract void dumpActivity(FileDescriptor filedescriptor, IBinder ibinder, String s, String as[])
        throws RemoteException;

    public abstract void dumpDbInfo(FileDescriptor filedescriptor, String as[])
        throws RemoteException;

    public abstract void dumpGfxInfo(FileDescriptor filedescriptor, String as[])
        throws RemoteException;

    public abstract void dumpHeap(boolean flag, String s, ParcelFileDescriptor parcelfiledescriptor)
        throws RemoteException;

    public abstract android.os.Debug.MemoryInfo dumpMemInfo(FileDescriptor filedescriptor, boolean flag, boolean flag1, String as[])
        throws RemoteException;

    public abstract String dumpMessageHistory()
        throws RemoteException;

    public abstract void dumpProvider(FileDescriptor filedescriptor, IBinder ibinder, String as[])
        throws RemoteException;

    public abstract void dumpService(FileDescriptor filedescriptor, IBinder ibinder, String as[])
        throws RemoteException;

    public abstract void enableLooperLog()
        throws RemoteException;

    public abstract void getMemoryInfo(android.os.Debug.MemoryInfo memoryinfo)
        throws RemoteException;

    public abstract void processInBackground()
        throws RemoteException;

    public abstract void profilerControl(boolean flag, String s, ParcelFileDescriptor parcelfiledescriptor, int i)
        throws RemoteException;

    public abstract void requestThumbnail(IBinder ibinder)
        throws RemoteException;

    public abstract void scheduleActivityConfigurationChanged(IBinder ibinder)
        throws RemoteException;

    public abstract void scheduleBindService(IBinder ibinder, Intent intent, boolean flag)
        throws RemoteException;
    ...
    public abstract void scheduleCreateService(IBinder ibinder, ServiceInfo serviceinfo, CompatibilityInfo compatibilityinfo)
        throws RemoteException;
    ...
    public abstract void scheduleNewIntent(List list, IBinder ibinder)
        throws RemoteException;

    public abstract void schedulePauseActivity(IBinder ibinder, boolean flag, boolean flag1, int i)
        throws RemoteException;
    ...
    public abstract void scheduleRelaunchActivity(IBinder ibinder, List list, List list1, int i, boolean flag, Configuration configuration)
        throws RemoteException;

    public abstract void scheduleResumeActivity(IBinder ibinder, boolean flag)
        throws RemoteException;

    public abstract void scheduleSendResult(IBinder ibinder, List list)
        throws RemoteException;

    public abstract void scheduleServiceArgs(IBinder ibinder, boolean flag, int i, int j, Intent intent)
        throws RemoteException;
    ...
    public abstract void setHttpProxy(String s, String s1, String s2)
        throws RemoteException;

    public abstract void setSchedulingGroup(int i)
        throws RemoteException;

    public abstract void setTrimMemoryFlagEx()
        throws RemoteException;
