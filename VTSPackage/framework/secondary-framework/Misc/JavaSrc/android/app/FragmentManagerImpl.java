...
//            FragmentManager, Activity, Fragment, BackStackRecord, 
...
;
    ...
    private void throwException(RuntimeException runtimeexception)
    {
        ...
        PrintWriter printwriter = new PrintWriter(new LogWriter(6, "FragmentManager"));
        if (mActivity != null)
        {
...
label1:
    ...
    Animator loadAnimator(Fragment fragment, int i, boolean flag, int j)
    {
        ...
        if (l == 0)
            ...
            return AnimatorInflater.loadAnimator(mActivity, l);
    }
    ...
    void makeInactive(Fragment fragment)
    {
        ...
        mActivity.invalidateFragment(fragment.mWho);
        fragment.initState();
    }
                ...
                if (fragmentmanagerstate.mActive != null)
                {
                    ...
                    for (int j = 0; j < fragmentmanagerstate.mBackStack.length; j++)
                    {
                        ...
                        if (DEBUG)
                        {
                            ...
                            backstackrecord.dump("  ", new PrintWriter(new LogWriter(2, "FragmentManager")), false);
                        }
                        mBackStack.add(backstackrecord);
