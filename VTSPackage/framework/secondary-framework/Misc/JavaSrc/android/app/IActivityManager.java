...
//            IProcessObserver, IUserSwitchObserver, IActivityController, Notification, 
//            IInstrumentationWatcher, IStopUserCallback
...
;
    ...
    public static final int APPLICATION_BINDED = 166;
    ...
    public static final int GET_PROCESS_PSWAP_TRANSACTION = 165;
    ...
    public static final int HALT_ACTIVITY_RESUMING = 163;
    ...
    public static final int NOTIFY_WINDOW_TIMEOUT = 162;
    ...
    public static final int RESTORE_ACTIVITY_RESUMING = 164;
    ...
    public abstract void activityStopped(IBinder ibinder, Bundle bundle, Bitmap bitmap, CharSequence charsequence)
        throws RemoteException;

    public abstract void applicationBinded(int i)
        throws RemoteException;
    ...
    public abstract boolean bindBackupAgent(ApplicationInfo applicationinfo, int i)
        throws RemoteException;

    public abstract int bindService(IApplicationThread iapplicationthread, IBinder ibinder, Intent intent, String s, IServiceConnection iserviceconnection, int i, int j)
        throws RemoteException;
    ...
    public abstract int checkGrantUriPermission(int i, String s, Uri uri, int j)
        throws RemoteException;
    ...
    public abstract void crashApplication(int i, int j, String s, String s1)
        throws RemoteException;

    public abstract void dismissKeyguardOnNextActivity()
        throws RemoteException;

    public abstract boolean dumpHeap(String s, int i, boolean flag, String s1, ParcelFileDescriptor parcelfiledescriptor)
        throws RemoteException;

    public abstract void enterSafeMode()
        throws RemoteException;

    public abstract boolean finishActivity(IBinder ibinder, int i, Intent intent)
        throws RemoteException;
    ...
    public abstract void finishReceiver(IBinder ibinder, int i, String s, Bundle bundle, boolean flag)
        throws RemoteException;
    ...
    public abstract long[] getProcessPswap(int ai[])
        throws RemoteException;
    ...
    public abstract List getRecentTasks(int i, int j, int k)
        throws RemoteException;
    ...
    public abstract ActivityManager.TaskThumbnails getTaskThumbnails(int i)
        throws RemoteException;

    public abstract Bitmap getTaskTopThumbnail(int i)
        throws RemoteException;

    public abstract List getTasks(int i, int j, IThumbnailReceiver ithumbnailreceiver)
        throws RemoteException;
    ...
    public abstract void grantUriPermission(IApplicationThread iapplicationthread, String s, Uri uri, int i)
        throws RemoteException;

    public abstract void grantUriPermissionFromOwner(IBinder ibinder, int i, String s, Uri uri, int j)
        throws RemoteException;

    public abstract boolean haltActivityResuming(int i)
        throws RemoteException;

    public abstract void handleApplicationCrash(IBinder ibinder, ApplicationErrorReport.CrashInfo crashinfo)
        throws RemoteException;
    ...
    public abstract boolean handleApplicationWtf(IBinder ibinder, String s, ApplicationErrorReport.CrashInfo crashinfo)
        throws RemoteException;

    public abstract int handleIncomingUser(int i, int j, int k, boolean flag, boolean flag1, String s, String s1)
        throws RemoteException;

    public abstract long inputDispatchingTimedOut(int i, boolean flag)
        throws RemoteException;
    ...
    public abstract boolean isUserRunning(int i, boolean flag)
        throws RemoteException;
    ...
    public abstract void killApplicationWithAppId(String s, int i)
        throws RemoteException;
    ...
    public abstract void moveTaskToBack(int i)
        throws RemoteException;
    ...
    public abstract void noteWakeupAlarm(IIntentSender iintentsender)
        throws RemoteException;

    public abstract void notifyWindowTimeout()
        throws RemoteException;

    public abstract ParcelFileDescriptor openContentUri(Uri uri)
        throws RemoteException;

    public abstract void overridePendingTransition(IBinder ibinder, String s, int i, int j)
        throws RemoteException;

    public abstract IBinder peekService(Intent intent, String s)
        throws RemoteException;

    public abstract boolean profileControl(String s, int i, boolean flag, String s1, ParcelFileDescriptor parcelfiledescriptor, int j)
        throws RemoteException;
    ...
    public abstract Intent registerReceiver(IApplicationThread iapplicationthread, String s, IIntentReceiver iintentreceiver, IntentFilter intentfilter, String s1, int i)
        throws RemoteException;

    public abstract void registerUserSwitchObserver(IUserSwitchObserver iuserswitchobserver)
        throws RemoteException;
    ...
    public abstract boolean removeSubTask(int i, int j)
        throws RemoteException;

    public abstract boolean removeTask(int i, int j)
        throws RemoteException;

    public abstract void reportThumbnail(IBinder ibinder, Bitmap bitmap, CharSequence charsequence)
        throws RemoteException;

    public abstract void requestBugReport()
        throws RemoteException;

    public abstract boolean restoreActivityResuming()
        throws RemoteException;

    public abstract void resumeAppSwitches()
        throws RemoteException;

    public abstract void revokeUriPermission(IApplicationThread iapplicationthread, Uri uri, int i)
        throws RemoteException;

    public abstract void revokeUriPermissionFromOwner(IBinder ibinder, Uri uri, int i)
        throws RemoteException;

    public abstract void serviceDoneExecuting(IBinder ibinder, int i, int j, int k)
        throws RemoteException;

    public abstract void setActivityController(IActivityController iactivitycontroller)
        throws RemoteException;
    ...
    public abstract void setLockScreenShown(boolean flag)
        throws RemoteException;
    ...
    public abstract void setProcessForeground(IBinder ibinder, int i, boolean flag)
        throws RemoteException;
    ...
    public abstract void setServiceForeground(ComponentName componentname, IBinder ibinder, int i, Notification notification, boolean flag)
        throws RemoteException;
    ...
    public abstract int startActivities(IApplicationThread iapplicationthread, Intent aintent[], String as[], IBinder ibinder, Bundle bundle, int i)
        throws RemoteException;
    ...
    public abstract int startActivity(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
            String s2, ParcelFileDescriptor parcelfiledescriptor, Bundle bundle)
        throws RemoteException;
    ...
    public abstract WaitResult startActivityAndWait(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
            String s2, ParcelFileDescriptor parcelfiledescriptor, Bundle bundle, int k)
        throws RemoteException;

    public abstract int startActivityAsUser(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
            String s2, ParcelFileDescriptor parcelfiledescriptor, Bundle bundle, int k)
        throws RemoteException;
    ...
    public abstract int startActivityWithConfig(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
            Configuration configuration, Bundle bundle, int k)
        throws RemoteException;

    public abstract boolean startInstrumentation(ComponentName componentname, String s, int i, Bundle bundle, IInstrumentationWatcher iinstrumentationwatcher, int j)
        throws RemoteException;

    public abstract boolean startNextMatchingActivity(IBinder ibinder, Intent intent, Bundle bundle)
        throws RemoteException;

    public abstract void startRunning(String s, String s1, String s2, String s3)
        throws RemoteException;

    public abstract ComponentName startService(IApplicationThread iapplicationthread, Intent intent, String s, int i)
        throws RemoteException;
    ...
    public abstract int stopUser(int i, IStopUserCallback istopusercallback)
        throws RemoteException;

    public abstract boolean switchUser(int i)
        throws RemoteException;

    public abstract boolean targetTaskAffinityMatchesActivity(IBinder ibinder, String s)
        throws RemoteException;
