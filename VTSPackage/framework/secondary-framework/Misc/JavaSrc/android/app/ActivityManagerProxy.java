...
//            IThumbnailReceiver, IProcessObserver, IUserSwitchObserver, IActivityController, 
//            Notification, IInstrumentationWatcher, IStopUserCallback
    ...
    implements IActivityManager
{
    ...
    public void applicationBinded(int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
        parcel.writeInterfaceToken("android.app.IActivityManager");
        parcel.writeInt(i);
        mRemote.transact(166, parcel, parcel1, 1);
        parcel1.readException();
        parcel.recycle();
        parcel1.recycle();
    }
    ...
    public boolean dumpHeap(String s, int i, boolean flag, String s1, ParcelFileDescriptor parcelfiledescriptor)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public IActivityManager.ContentProviderHolder getContentProvider(IApplicationThread iapplicationthread, String s, int i, boolean flag)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public IActivityManager.ContentProviderHolder getContentProviderExternal(String s, int i, IBinder ibinder)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
        ...
        throws RemoteException
    {
        ...
        parcel1.readException();
        IIntentSender iintentsender = android.content.IIntentSender.Stub.asInterface(parcel1.readStrongBinder());
        parcel.recycle();
        parcel1.recycle();
    ...
    public long[] getProcessPswap(int ai[])
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public List getRecentTasks(int i, int j, int k)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public boolean haltActivityResuming(int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public boolean handleApplicationWtf(IBinder ibinder, String s, ApplicationErrorReport.CrashInfo crashinfo)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public long inputDispatchingTimedOut(int i, boolean flag)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public boolean isUserRunning(int i, boolean flag)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public void killApplicationWithAppId(String s, int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public boolean profileControl(String s, int i, boolean flag, String s1, ParcelFileDescriptor parcelfiledescriptor, int j)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public Intent registerReceiver(IApplicationThread iapplicationthread, String s, IIntentReceiver iintentreceiver, IntentFilter intentfilter, String s1, int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public void setLockScreenShown(boolean flag)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public void setProcessForeground(IBinder ibinder, int i, boolean flag)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public void setServiceForeground(ComponentName componentname, IBinder ibinder, int i, Notification notification, boolean flag)
        throws RemoteException
    {
        int j = 1;
        Parcel parcel = Parcel.obtain();
    ...
    public int startActivities(IApplicationThread iapplicationthread, Intent aintent[], String as[], IBinder ibinder, Bundle bundle, int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public int startActivity(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
        ...
        throws RemoteException
    {
        Trace.traceBegin(64L, "amStartActivity");
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
        parcel.writeInterfaceToken("android.app.IActivityManager");
        IBinder ibinder1;
        ...
        throws RemoteException
    {
        ...
        parcel1.readException();
        IActivityManager.WaitResult waitresult = (IActivityManager.WaitResult)IActivityManager.WaitResult.CREATOR.createFromParcel(parcel1);
        parcel1.recycle();
        parcel.recycle();
        return waitresult;
    }

    public int startActivityAsUser(IApplicationThread iapplicationthread, Intent intent, String s, IBinder ibinder, String s1, int i, int j, 
            String s2, ParcelFileDescriptor parcelfiledescriptor, Bundle bundle, int k)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
    ...
    public boolean startInstrumentation(ComponentName componentname, String s, int i, Bundle bundle, IInstrumentationWatcher iinstrumentationwatcher, int j)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public void startRunning(String s, String s1, String s2, String s3)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
    ...
    public ComponentName startService(IApplicationThread iapplicationthread, Intent intent, String s, int i)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
        ...
        throws RemoteException
    {
        ...
        parcel.writeInterfaceToken("android.app.IActivityManager");
        parcel.writeInt(i);
        parcel.writeStrongInterface(istopusercallback);
    ...
    public boolean targetTaskAffinityMatchesActivity(IBinder ibinder, String s)
        throws RemoteException
    {
        Parcel parcel = Parcel.obtain();
        Parcel parcel1 = Parcel.obtain();
