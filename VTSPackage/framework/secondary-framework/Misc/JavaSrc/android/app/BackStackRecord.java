    ...
    implements FragmentManager.BackStackEntry, Runnable
{
    ...
    int commitInternal(boolean flag)
    {
        ...
        if (FragmentManagerImpl.DEBUG)
        {
            ...
            dump("  ", null, new PrintWriter(new LogWriter(2, "FragmentManager")), null);
        }
        mCommitted = true;
        if (mAddToBackStack)
    ...
    public CharSequence getBreadCrumbTitle()
    {
        if (mBreadCrumbTitleRes != 0)
        {
            if (mManager == null)
            {
                Log.e("FragmentManager", "(getBreadCrumbTitle)mManager is null");
                return mTmpTitle;
            }
            if (mManager.mActivity == null)
            {
                Log.e("FragmentManager", "(getBreadCrumbTitle)mManager.mActivity is null");
                return mTmpTitle;
            } else
            {
