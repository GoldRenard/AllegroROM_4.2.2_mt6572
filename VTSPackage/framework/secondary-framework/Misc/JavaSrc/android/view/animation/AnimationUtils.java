...
label0:
        ...
        throws XmlPullParserException, IOException
    {
        ...
        do
        {
            ...
            if (j == 2)
            {
                ...
                if (s.equals("decelerateInterpolatorEx"))
                    obj = new DecelerateInterpolatorEx(context, attributeset);
                else
    ...
    public static Animation makeInAnimation(Context context, boolean flag)
    {
        ...
        if (flag)
            ...
            animation = loadAnimation(context, 0x10a0057);
    ...
    {
        Animation animation = loadAnimation(context, 0x10a0056);
    ...
    public static Animation makeOutAnimation(Context context, boolean flag)
    {
        ...
        if (flag)
            ...
            animation = loadAnimation(context, 0x10a005a);
        animation.setInterpolator(new AccelerateInterpolator());
        animation.setStartTime(currentAnimationTimeMillis());
        return animation;
    }
