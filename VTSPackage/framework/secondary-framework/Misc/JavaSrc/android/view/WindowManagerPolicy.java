...
public interface WindowManagerPolicy
{
    ...
    public abstract void applyPostLayoutPolicyLw(WindowState windowstate, WindowManager.LayoutParams layoutparams);

    public abstract void beginLayoutLw(boolean flag, int i, int j, int k);
    ...
    public abstract boolean canMagnifyWindowLw(WindowManager.LayoutParams layoutparams);
