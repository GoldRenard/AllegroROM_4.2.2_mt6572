...
//            HardwareCanvas, GLES20DisplayList, GLES20Layer, GLES20RenderLayer, 
...
class GLES20Canvas extends HardwareCanvas
{
    ...
    private static native void nPushLayerUpdate(int i, int j);
    ...
    static native boolean nResizeLayer(int i, int j, int k, int ai[]);
    ...
    static native void nSetLayerColorFilter(int i, int j);

    static native void nSetLayerPaint(int i, int j);

    private static native void nSetMatrix(int i, int j);

    static native void nSetOpaqueLayer(int i, boolean flag);
...
_L3:
    ...
    {
        int i = ((GLES20Layer)hardwarelayer).getLayer();
        int j;
        if (paint == null)
            j = 0;
        else
...
_L2:
    ...
    {
        if (rect != null)
            return nPrepareDirty(mRenderer, rect.left, rect.top, rect.right, rect.bottom, mOpaque);
        else
    ...
    {
        nPushLayerUpdate(mRenderer, ((GLES20Layer) ((GLES20RenderLayer)hardwarelayer)).mLayer);
    }
    ...
    public int saveLayer(float f, float f1, float f2, float f3, Paint paint, int i)
    {
        ...
        k = 0;
_L1:
        l = nSaveLayer(mRenderer, f, f1, f2, f3, k, i);
        if (j != 0)
...
_L3:
    ...
    {
        if (f < f2 && f1 < f3)
            return nSaveLayerAlpha(mRenderer, f, f1, f2, f3, i, j);
        else
            return save(j);
    }
    ...
    {
        if (rectf != null)
            return saveLayerAlpha(rectf.left, rectf.top, rectf.right, rectf.bottom, i, j);
        else
            return nSaveLayerAlpha(mRenderer, i, j);
    }
