...
.method private eccButtonShouldShow()Z
    ...
    .line 197
    .local v5, plmnDefaultStr:Ljava/lang/String;
    ...
    const-string v10, "plmnDefaultStr = "
    ...
    invoke-virtual {v8, v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getTelephonyPlmn(I)Ljava/lang/CharSequence;

    move-result-object v1

    .line 201
    .local v1, mPlmn:Ljava/lang/CharSequence;
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/EmergencyButton;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v8, v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getTelephonySpn(I)Ljava/lang/CharSequence;

    move-result-object v3

    .line 202
    .local v3, mSpn:Ljava/lang/CharSequence;
    if-eqz v1, :cond_1
    ...
    .line 208
    .end local v1           #mPlmn:Ljava/lang/CharSequence;
    .end local v2           #mPlmnIsNotDefault:Z
    .end local v3           #mSpn:Ljava/lang/CharSequence;
    .end local v4           #mSpnIsNotDefault:Z
    :cond_0
    :goto_3
    return v6

    .restart local v1       #mPlmn:Ljava/lang/CharSequence;
    .restart local v3       #mSpn:Ljava/lang/CharSequence;
    :cond_1
    move v2, v7
    ...
    .restart local v2       #mPlmnIsNotDefault:Z
    :cond_2
    move v4, v7
    ...
    .line 199
    .restart local v4       #mSpnIsNotDefault:Z
    :cond_3
