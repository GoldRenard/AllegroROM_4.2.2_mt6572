...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;,
...
.field private static final LQ_LOCKVIEW_CONFIG_FILE:Ljava/lang/String; = null

.field private static final TAG:Ljava/lang/String; = "KeyguardHostView"

.field private static final TAG_LOCK_NAME_CONFIG:Ljava/lang/String; = "lockviewfavorite"


# instance fields
.field private DEBUG_LQ_LOCKVIEW:Z
...
.field private mLQLockClassName:Ljava/lang/String;

.field public mLQLockView:Landroid/view/View;

.field private mLQLockViewPKName:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "/yunlan_lockview_config.xml"
    ...
    sput-object v0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->LQ_LOCKVIEW_CONFIG_FILE:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 134
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLaunchingCamera:Z

    .line 144
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->DEBUG_LQ_LOCKVIEW:Z

    .line 145
    iput-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;
    ...
    iget-object v5, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mOnClickHandler:Landroid/widget/RemoteViews$OnClickHandler;

    invoke-static {}, Landroid/os/Looper;->myLooper()Landroid/os/Looper;

    move-result-object v6

    invoke-direct {v3, p1, v4, v5, v6}, Landroid/appwidget/AppWidgetHost;-><init>(Landroid/content/Context;ILandroid/widget/RemoteViews$OnClickHandler;Landroid/os/Looper;)V
    ...
    invoke-virtual {v3, v4}, Landroid/appwidget/AppWidgetHost;->setUserId(I)V
    ...
    .line 187
    invoke-virtual {v0, v7}, Landroid/app/admin/DevicePolicyManager;->getCameraDisabled(Landroid/content/ComponentName;)Z
    ...
    .line 205
    :cond_3
    const-string v1, "ro.rgk.sm611.style"

    invoke-static {v1}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string v2, "samsun"
    ...
    .line 206
    invoke-direct {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->getLQLockViewName()V
...
.method static synthetic access$2800(Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 87
    iget-boolean v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->DEBUG_LQ_LOCKVIEW:Z
...
.method private getLQLockViewName()V
    .locals 5
    ...
    .line 2126
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->DEBUG_LQ_LOCKVIEW:Z
    ...
    const-string v3, "getLQLockViewName-------------1"

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2128
    :cond_0
    new-instance v0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;

    invoke-direct {v0, p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;-><init>(Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;)V

    .line 2129
    .local v0, ch:Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;
    sget-object v2, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->LQ_LOCKVIEW_CONFIG_FILE:Ljava/lang/String;

    invoke-direct {p0, v2, v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->getXMLFile(Ljava/lang/String;Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;)Z

    move-result v1

    .line 2130
    .local v1, ret:Z
    iput-object v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockViewPKName:Ljava/lang/String;

    .line 2131
    iput-object v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockClassName:Ljava/lang/String;

    .line 2132
    if-eqz v1, :cond_1

    .line 2133
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;->getLockPackName()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockViewPKName:Ljava/lang/String;

    .line 2134
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;->getLockClassName()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockClassName:Ljava/lang/String;
    ...
    const-string v4, "getLQLockViewName-------------1"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockViewPKName:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockClassName:Ljava/lang/String;
    ...
    const-string v4, "getLQLockViewName-------------2"
...
.method private getXMLFile(Ljava/lang/String;)Ljava/lang/String;
    .locals 8
    .parameter "filename"
    ...
    .line 2148
    .local v3, i:I
    iget-boolean v5, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->DEBUG_LQ_LOCKVIEW:Z
    ...
    const-string v7, "getXMLFile read:"
...
.method private getXMLFile(Ljava/lang/String;Lcom/android/internal/policy/impl/keyguard/KeyguardHostView$ContentHandler;)Z
    .locals 8
    .parameter "filename"
    ...
    .line 2164
    invoke-direct {p0, p1}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->getXMLFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    .end local v6           #strReader:Ljava/io/StringReader;
    :cond_0
    :goto_0
    return v4
...
.method private showSecurityScreen(Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityModel$SecurityMode;)V
    ...
    .line 1174
    const-string v10, "ro.rgk.sm611.style"

    invoke-static {v10}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    const-string v11, "samsun"
    ...
    iget-object v11, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;

    check-cast v7, Lcom/android/internal/policy/impl/keyguard/KeyguardSelectorView;

    .end local v7           #newView:Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityView;
    invoke-virtual {v10, v11, v7}, Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;->setLockView(Landroid/view/View;Lcom/android/internal/policy/impl/keyguard/KeyguardSelectorView;)V
    ...
    .restart local v7       #newView:Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityView;
    :cond_13
    const/4 v4, 0x0
    ...
    invoke-virtual {v10, v11, v12}, Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;->setLockView(Landroid/view/View;Lcom/android/internal/policy/impl/keyguard/KeyguardSelectorView;)V
...
.method public cleanUp()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;->setKeyguardCallback(Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityCallback;)V
    ...
    .line 1902
    iget-object v0, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;
...
.method public getCurScreen(Landroid/content/Context;Landroid/content/res/Configuration;)Landroid/view/View;
    .locals 10
    .parameter "context"
    ...
    .line 2043
    .local v4, mmsCtx:Landroid/content/Context;
    iget-boolean v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->DEBUG_LQ_LOCKVIEW:Z
    ...
    const-string v8, "getCurScreen ------------1"

    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 2046
    :cond_0
    iget-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockViewPKName:Ljava/lang/String;

    if-eqz v7, :cond_1

    iget-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockClassName:Ljava/lang/String;
    ...
    const-string v8, "getCurScreen ------------2"
    ...
    const-string v8, "getCurScreen -------------3"
    ...
    .line 2066
    .local v3, maClass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    :try_start_1
    iget-object v7, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockClassName:Ljava/lang/String;
    ...
    const-string v9, "getCurScreen -------------4 --- "
    ...
    const-class v8, Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityCallback;
    ...
    const-string v8, "getCurScreen -------------41"
    ...
    const-string v8, "getCurScreen -------------42"
    ...
    const-string v8, "getCurScreen------------5"
    ...
    .end local v3           #maClass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    ...
    const-string v9, "getCurScreen -------------createPackageContext  "
    ...
    .restart local v3       #maClass:Ljava/lang/Class;,"Ljava/lang/Class<*>;"
    :catch_1
    move-exception v2
    ...
    .restart local v5       #params:[Ljava/lang/Class;
    :catch_2
    move-exception v2
    ...
    const-string v9, "getCurScreen -------------err1"
    ...
    const-string v9, "getCurScreen -------------err2"
    ...
    const-string v9, "getCurScreen -------------err3"
    ...
    const-string v9, "getCurScreen -------------err4"
    ...
    const-string v8, "getCurScreen -------------err5"
    ...
    const-string v8, "getCurScreen -------------err6"
...
.method protected onFinishInflate()V
    ...
    check-cast v10, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;

    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;
    ...
    invoke-virtual {v10, v12}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setVisibility(I)V

    .line 318
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;

    iget-object v11, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mWidgetCallbacks:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager$Callbacks;

    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setCallbacks(Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager$Callbacks;)V

    .line 319
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mAppWidgetContainer:Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;

    invoke-virtual {v10, v2}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setDeleteDropTarget(Landroid/view/View;)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setMinScale(F)V

    .line 322
    const v10, 0x10202b9

    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->findViewById(I)Landroid/view/View;

    move-result-object v10

    check-cast v10, Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;

    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mSlidingChallengeLayout:Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;
    ...
    check-cast v10, Lcom/android/internal/policy/impl/keyguard/MultiPaneChallengeLayout;

    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mMultiPaneChallengeLayout:Lcom/android/internal/policy/impl/keyguard/MultiPaneChallengeLayout;
    ...
    iget-object v11, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mViewStateManager:Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;

    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout;->setOnChallengeScrolledListener(Lcom/android/internal/policy/impl/keyguard/SlidingChallengeLayout$OnChallengeScrolledListener;)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setViewStateManager(Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setLockPatternUtils(Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    invoke-interface {v0, v10}, Lcom/android/internal/policy/impl/keyguard/ChallengeLayout;->setOnBouncerStateChangedListener(Lcom/android/internal/policy/impl/keyguard/ChallengeLayout$OnBouncerStateChangedListener;)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setBouncerAnimationDuration(I)V
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;->setPagedView(Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;)V

    .line 337
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mViewStateManager:Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;

    invoke-virtual {v10, v0}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;->setChallengeLayout(Lcom/android/internal/policy/impl/keyguard/ChallengeLayout;)V
    ...
    check-cast v10, Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityViewFlipper;

    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mSecurityViewContainer:Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityViewFlipper;
    ...
    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mKeyguardSelectorView:Lcom/android/internal/policy/impl/keyguard/KeyguardSelectorView;
    ...
    invoke-virtual {v10, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;->setSecurityViewContainer(Lcom/android/internal/policy/impl/keyguard/KeyguardSecurityView;)V
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->setSystemUiVisibility(I)V
    ...
    invoke-virtual {p0, v10, v6}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->getCurScreen(Landroid/content/Context;Landroid/content/res/Configuration;)Landroid/view/View;

    move-result-object v10

    iput-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;

    .line 352
    const-string v10, "KeyguardHostView"

    const-string v11, "createLockScreen---------1"
    ...
    :goto_1
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;
    ...
    .line 367
    .local v9, unLockPanel:Landroid/widget/FrameLayout;
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;
    ...
    const-string v11, "onFinishInflate---------3"

    invoke-static {v10, v11}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 372
    .end local v8           #params:Landroid/widget/FrameLayout$LayoutParams;
    .end local v9           #unLockPanel:Landroid/widget/FrameLayout;
    :cond_3
    const-string v10, "KeyguardHostView"

    const-string v11, "onFinishInflate---------4"
    ...
    invoke-virtual {v10, v12}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->setAddWidgetEnabled(Z)V
    ...
    .line 382
    iget-object v10, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mSwitchPageRunnable:Ljava/lang/Runnable;
    ...
    invoke-virtual {v10}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewStateManager;->showUsabilityHints()V

    .line 386
    invoke-virtual {p0, v12}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->showPrimarySecurityScreen(Z)V
    ...
    const-string v11, "createLockScreen---------1------Exception"
...
.method public onScreenTurnedOff()V
    ...
    .line 1248
    iget-object v1, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->mLQLockView:Landroid/view/View;

    if-eqz v1, :cond_3

    .line 1249
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->hideLockPadView()V
...
.method public onScreenTurnedOn()V
    ...
    .line 1200
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/keyguard/KeyguardHostView;->showLockPadView()V
